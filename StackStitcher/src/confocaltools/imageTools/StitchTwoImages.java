...
//taken from Stephan Preibisch's GPL imageJ plugin "stitching_2D".
//Library is from same source.
...
public class StitchTwoImages implements PlugIn
{
    ...
    public StitchTwoImages()
    {
    }
 
    public StitchTwoImages(boolean windowing1, int checkPeaks1, boolean fuseImages1, String method1, String fusedImageName1)
    {
